  ...
  return (
    <div>
      <section className="w-full h-screen">
        <img
          src="../assets/kids/kids-banner.jpg" // replace with actual path
          alt="Banner"
      ...
      <section className="w-full">
        <div className="flex flex-col md:flex-row w-full">
          ...
          <figure className="w-full md:w-1/2">
            <img
              src="../assets/kids/banner2-left.jpg" // Replace with actual image
              alt="Gallery Image 1"
          ...
          <figure className="w-full md:w-1/2 mt-4 md:mt-0">
            <img
              src="../assets/kids/banner2-right.jpg" // Replace with actual image
              alt="Gallery Image 2"
              className="w-full h-[760.4px] object-fit"
            />
          </figure>
      ...
      <section className="w-full flex justify-center px-4 md:px-8 lg:px-20 xl:px-32 2xl:px-40 my-16">
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <div className="flex flex-col">
            <img
              src="../assets/kids/bottom-left.jpg"
              alt="Center Left"
              className="w-[160px] h-[240px] sm:w-[200px] sm:h-[300px] md:w-[300px] md:h-[450px] lg:w-[460px] lg:h-[690px] object-cover"
            />
            <div className="mt-4 space-y-2 ">
          ...
          <div className="flex flex-col">
            <img
              src="../assets/kids/bottom-right.jpg"
              alt="Center Right"
              className="w-[160px] h-[240px] sm:w-[200px] sm:h-[300px] md:w-[300px] md:h-[450px] lg:w-[460px] lg:h-[690px] object-cover"
            />
            <div className="mt-4 space-y-2">
